...
async function main() {
    ...
    const createObjectTypes = async (types, category) => {
    ...
    await createObjectTypes(furnitureTypes, client_1.ObjectCategory.furniture);
    await createObjectTypes(applianceTypes, client_1.ObjectCategory.appliance);
    await createObjectTypes(facilityTypes, client_1.ObjectCategory.facility);
    await createObjectTypes(otherTypes, client_1.ObjectCategory.other);
